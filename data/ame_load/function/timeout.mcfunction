...
summon minecraft:marker ~ ~ ~ {Tags:["macro.timeout"],CustomName:'{"text":"macroAPI"}'}
execute as @e[type=minecraft:marker,tag=macro.timeout,limit=1] run say [macroAPI GATE] Timeout — no admin response in 5 minutes. Auto-cancelling.
