...
summon minecraft:marker ~ ~ ~ {Tags:["macro.gate_no"],CustomName:'{"text":"macroAPI"}'}
execute as @e[type=minecraft:marker,tag=macro.gate_no,limit=1] run say [macroAPI GATE] ========================================
execute as @e[type=minecraft:marker,tag=macro.gate_no,limit=1] run say [macroAPI GATE] Load CANCELLED. macro:engine storage was NOT modified.
execute as @e[type=minecraft:marker,tag=macro.gate_no,limit=1] run say [macroAPI GATE] Engine is NOT running.
execute as @e[type=minecraft:marker,tag=macro.gate_no,limit=1] run say [macroAPI GATE] To retry: /reload  or  /function ame_load:_
execute as @e[type=minecraft:marker,tag=macro.gate_no,limit=1] run say [macroAPI GATE] ========================================
