...
summon minecraft:marker ~ ~ ~ {Tags:["macro.gate_exec"],CustomName:'{"text":"macroAPI"}'}
execute as @e[type=minecraft:marker,tag=macro.gate_exec,limit=1] run say [macroAPI GATE] Dangerous command CONFIRMED. Executing...
