...
$tellraw @a[tag=macro.debug] ["",{"text":"[macroAPI] ","color":"#00AAAA","bold":true},{"text":"string/format_ticks ","color":"aqua"},{"text":"$(ticks)t","color":"white"},{"text":" → ","color":"#555555"},{"storage":"macro:output","nbt":"minutes","color":"green"},{"text":"m ","color":"#555555"},{"storage":"macro:output","nbt":"seconds","color":"green"},{"text":"s","color":"#555555"}]
