...
$tellraw @a[tag=macro.debug] {"text":"","extra":[{"text":"[macroAPI] ","color":"#00AAAA","bold":true},{"text":"math/divmod ","color":"aqua"},{"text":"($(value)/$(divisor))","color":"gray"},{"text":" → ","color":"#555555"},{"text":"q=","color":"gray"},{"storage":"macro:output","nbt":"quotient","color":"green"},{"text":" r=","color":"gray"},{"storage":"macro:output","nbt":"remainder","color":"green"}]}
