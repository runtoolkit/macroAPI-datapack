...
$tellraw @a[tag=macro.debug] ["",{"text":"[macroAPI] ","color":"#00AAAA","bold":true},{"text":"player/get_armor ","color":"aqua"},{"text":"$(player) → armor=","color":"gray"},{"storage":"macro:output","nbt":"result","color":"green"},{"text":" toughness=","color":"gray"},{"storage":"macro:output","nbt":"toughness","color":"green"}]
