...
tellraw @s ["",{"text":" ┃ ","color":"#555555"},{"text":"Author ","color":"gray"},{"text":"tickwarden","color":"#00ff33"},{"text":" / ","color":"#555555"},{"text":"ToolkitMC","color":"aqua","underlined":true,"click_event":{"action":"open_url","url":"https://github.com/ToolkitMC/macroAPI"}}]
tellraw @s ["",{"text":" ┃ ","color":"#555555"},{"text":"Source ","color":"gray"},{"text":"github.com/ToolkitMC/macroAPI","color":"#5555ff","underlined":true,"click_event":{"action":"open_url","url":"https://github.com/ToolkitMC/macroAPI"}}]
