...
tellraw @a[tag=macro.debug] {"text":"","extra":[{"text":"[macroAPI] ","color":"#00AAAA","bold":true},{"text":"math/vec/angle_between ","color":"aqua"},{"text":"cos×1000=","color":"gray"},{"score":{"name":"$vang_dot","objective":"macro.tmp"},"color":"yellow"},{"text":" → ","color":"gray"},{"storage":"macro:output","nbt":"result","color":"yellow"},{"text":"°","color":"gray"}]}
