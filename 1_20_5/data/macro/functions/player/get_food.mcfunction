...
$tellraw @a[tag=macro.debug] {"text":"","extra":[{"text":"[macroAPI] ","color":"#00AAAA","bold":true},{"text":"player/get_food ","color":"aqua"},{"text":"$(player) → food=","color":"gray"},{"storage":"macro:output","nbt":"food","color":"green"},{"text":" sat=","color":"gray"},{"storage":"macro:output","nbt":"saturation","color":"green"}]}
