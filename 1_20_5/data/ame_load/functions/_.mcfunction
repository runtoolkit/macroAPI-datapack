# Stage 0 Load
summon minecraft:marker ~ ~ ~ {Tags:["macro.stage0"],CustomName:'{"text":"macroAPI"}'}
execute as @e[type=minecraft:marker,tag=macro.stage0,limit=1] run say Loading #macroAPI...
